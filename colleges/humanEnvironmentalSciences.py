...
department_links = {
    "https://ches.ua.edu/ctd/directory/",
    "https://ches.ua.edu/csm/consumer-sciences-directory/",
    "https://ches.ua.edu/health-science/directory/",
    "https://ches.ua.edu/hdfs/hdfs-directory/",
    "https://ches.ua.edu/hes/directory/",
    "https://ches.ua.edu/nhm/directory/",
}
...
def collect_data():
    ...
    # df.to_csv('humanEnvironmentalSciences_professors.csv', index=False)